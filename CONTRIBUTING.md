...
- Do not submit material copied from another project unless its provenance and license are clearly identified and compatible with its intended use.
- Do not remove or alter third-party copyright/license notices.
- Do not submit credentials, private data, user media, generated runtime trees, caches, or unrelated project material.
- Do not change `LICENSE`, `COPYRIGHT.md`, `THIRD_PARTY_NOTICES.md`, contributor terms, or the project licensing policy without explicit owner approval.
- State whether a contribution includes or is derived from any third-party material.

Pull requests should confirm these terms using the repository pull-request template.
