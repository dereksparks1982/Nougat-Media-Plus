# Nougat Play Portal v0.0.31 - Exact Approved UI Sheet Components - Validation
...
- `Nougat_Play_Portal_v31 --version` reports `Nougat Play Portal v0.0.31`;
