# Nougat Play Portal v0.0.28 Validation Record
...
- Stub executable `--version`: PASS (`Nougat Play Portal v0.0.28`).
...
- final root `Nougat_Play_Portal_v28` install, executable/version/RPATH verification;
