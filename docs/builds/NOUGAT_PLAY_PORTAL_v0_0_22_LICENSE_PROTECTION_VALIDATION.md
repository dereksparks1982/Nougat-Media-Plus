# Nougat Play Portal v0.0.22 License Protection Validation
...
- accepted `Nougat_Play_Portal_v21` is verified using the exact accepted llama.cpp runtime at the renamed Nougat Play Portal project path;
...
- `Nougat_Play_Portal_v22 --version` reports `Nougat Play Portal v0.0.22`;
