# Nougat Play Portal v0.0.29 — TV Playback, Navigation, and Carry-Forward UI Repair — Build Handshake
...
- Target root executable: `Nougat_Play_Portal_v29`
- Changed-files package: `Nougat_Play_Portal_v0_0_29_TV_RELIABILITY_AND_UI_REPAIR_CHANGED_FILES_ONLY.zip`
...
- `src/main.cpp`
- `CMakeLists.txt`
- current/unversioned and versioned desktop launchers through `NougatPlayPortal_v29.desktop`
...
- Existing accepted root executable `Nougat_Play_Portal_v28` is retained until the final v29 executable has passed validation and been installed.
