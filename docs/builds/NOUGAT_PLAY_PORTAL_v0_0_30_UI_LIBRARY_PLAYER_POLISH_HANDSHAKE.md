# Nougat Play Portal v0.0.30 — UI Cohesion, Library Performance, and Player Navigation — Build Handshake
...
- Target root executable: `Nougat_Play_Portal_v30`
- Changed-files package: `Nougat_Play_Portal_v0_0_30_UI_LIBRARY_PLAYER_POLISH_CHANGED_FILES_ONLY.zip`
...
- `CMakeLists.txt`
- current/unversioned and compatibility desktop launchers through `NougatPlayPortal_v30.desktop`
...
- Existing accepted root executable `Nougat_Play_Portal_v29` is retained until the final v30 executable has passed validation and is ready to replace it.
