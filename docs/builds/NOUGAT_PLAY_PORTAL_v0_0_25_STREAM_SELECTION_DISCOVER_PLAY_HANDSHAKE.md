# Nougat Play Portal v0.0.25 Stream Selection and Discover Play Handshake
...
- Required installed base executable: `Nougat_Play_Portal_v24`
- Target executable: `Nougat_Play_Portal_v25`
- Package: `Nougat_Play_Portal_v0_0_25_STREAM_PROVIDER_PANEL_REMOVAL_REPAIR_CHANGED_FILES_ONLY.zip`
...
For this same-version repair, installer rollback target is the exact rejected pre-repair v0.0.25 candidate state, including its existing `Nougat_Play_Portal_v25` executable. A failed repair restores that exact v0.0.25 candidate rather than rolling all the way back to v0.0.24.
