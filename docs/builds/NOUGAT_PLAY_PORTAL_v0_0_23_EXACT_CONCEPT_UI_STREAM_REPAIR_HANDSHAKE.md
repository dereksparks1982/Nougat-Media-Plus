# Nougat Play Portal v0.0.23 — Exact Concept UI and Stream Repair Handshake

## Project and release
- Project: Nougat Play Portal
...
- Required current root executable: `Nougat_Play_Portal_v22`
- Required v22 executable SHA-256: `651ba56069f97170b7f94cce2d019de703c18fa7f8d8e51775a61caf92e843a5`
- Target root executable: `Nougat_Play_Portal_v23`
- Package: `Nougat_Play_Portal_v0_0_23_EXACT_CONCEPT_UI_STREAM_REPAIR_CHANGED_FILES_ONLY.zip`
...
- `README.md`
- `ROADMAP.md`
- `assets/icons/nougat-play-portal.png`
- `assets/icons/nougat-play-portal-14.png`
- `assets/icons/nougat-play-portal-16.png`
- `assets/icons/nougat-play-portal-32.png`
- `assets/icons/nougat-play-portal-48.png`
- `assets/icons/nougat-play-portal-64.png`
- `assets/icons/nougat-play-portal-128.png`
- `assets/icons/nougat-play-portal-256.png`
- `assets/icons/nougat-play-portal-512.png`
- `docs/NOUGAT_PLAY_PORTAL_BRAND_PALETTE.md`
- `src/main.cpp`
...
- `tools/test_nougat_play_portal_ui_smoke_v23.py`
...
`$HOME/DKLab/Archives/ReddMedia Archive/Nougat_Play_Portal_pre_v0_0_23_<timestamp>`

On any post-apply validation failure, the installer restores the exact pre-v0.0.23 touched files and the root `Nougat_Play_Portal_v22`. It preserves the separately committed licensing files, runtime/model data, media/server data, and owner-uploaded source ZIPs.
...
- Current Nougat Play Portal project at the required base above.
