# Nougat Play Portal v0.0.24 Literal Concept-Sheet N App-Wide Repair Handshake
...
- Target executable: `Nougat_Play_Portal_v24`
- Package: `Nougat_Play_Portal_v0_0_24_LITERAL_CONCEPT_SHEET_N_APP_WIDE_REPAIR_CHANGED_FILES_ONLY.zip`
...
6. Use fresh icon key `nougat-play-portal-concept-sheet-v24` and install the same pixels under legacy/current GNOME icon aliases so stale cache lookup cannot resurrect the old artwork.
