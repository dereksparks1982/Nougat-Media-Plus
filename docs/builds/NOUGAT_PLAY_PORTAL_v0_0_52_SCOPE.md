# Nougat Play Portal v0.0.52 Scope
...
v0.0.52 is a **Radio-only functional build**. It replaces the rejected v0.0.51 Radio shell with a real receiver/scanner architecture. No unrelated rejected-v0.0.51 repair is part of this candidate. All non-Radio carry-forward work is assigned to v0.0.53 in `NOUGAT_PLAY_PORTAL_v0_0_53_CARRY_FORWARD.md`.
...
- exact `Nougat Play Portal v0.0.52` CLI identity,
- v52 static Radio contracts,
- no dead v51 Radio-shell text,
- prior executable rollback preservation before replacement,
- only `Nougat_Play_Portal_v52` remains as the active versioned root executable after successful promotion,
