# Nougat Play Portal v0.0.53 Xbox 360 XWayland Bridge Validation
...
named `Nougat Play Portal`. Linux dynamic-loader preload lists use whitespace
...
- The complete test was repeated with the hook and mock stored beneath a path
  containing `Nougat Play Portal`; the private no-space preload path loaded the
  hook successfully.
