# Nougat Play Portal v0.0.22 License Protection Handshake

## Base and target

- Required accepted base: commit `b89b0fc187bebc05f3390a76c76cbdc980713600` / tag `v0.0.21`.
- Accepted snapshot: `$HOME/DKLab/Archives/ReddMedia Archive/Nougat_Play_Portal_v0.0.21_ACCEPTED_20260821_025505`.
- Active local repository path: `$HOME/DKLab/Projects/Nougat Play Portal`.
- GitHub repository: `dereksparks1982/Nougat-Play-Portal`.
- Target: v0.0.22 candidate.
- Target root executable: `Nougat_Play_Portal_v22`.
...
`Nougat_Play_Portal_v0_0_22_LICENSE_PROTECTION_RUNTIME_PATH_REPAIR_CHANGED_FILES_ONLY.zip`
