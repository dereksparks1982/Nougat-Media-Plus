# Nougat Play Portal v0.0.55 Web Player candidate icon repair validation
...
`Nougat_Play_Portal_v55` executable in Files/Nautilus. Under the Company Bible,
...
1. leave the final `Nougat_Play_Portal_v55` bytes in place;
...
5. keep `Icon=nougat-play-portal`, `StartupWMClass=NougatPlayPortal`, and
...
- both project desktop launchers target `Nougat_Play_Portal_v55`.
- both project desktop launchers use `Icon=nougat-play-portal`.
