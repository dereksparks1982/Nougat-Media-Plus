# Nougat Play Portal v0.0.53 Carry-Forward
...
- Ubuntu Processes/System Monitor must identify the running product clearly as Nougat Play Portal so ordinary external End/Kill works.
