# Nougat Play Portal v0.0.32 Native P2P Media + Player/UI Repair Handshake

## Base
- Accepted/published v0.0.31 commit: `b22d11d4989784dc6df56abbde08344720064790`.
- Accepted v0.0.31 root executable: `Nougat_Play_Portal_v31`.
...
## Package
`Nougat_Play_Portal_v0_0_32_NATIVE_P2P_MEDIA_AND_PLAYER_UI_REPAIR_CHANGED_FILES_ONLY.zip`
