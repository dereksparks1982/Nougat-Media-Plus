# Nougat Play Portal v0.0.51 Rejected Build Log
...
Nougat Play Portal v0.0.51 is REJECTED by the owner.
...
Nougat_Play_Portal_v50 beside Nougat_Play_Portal_v51.

The owner manually removed the old executable.

Required permanent rule:

- Successful v0.0.51 promotion leaves Nougat_Play_Portal_v51 as the only
  versioned Nougat executable in the project root.
- Nougat_Play_Portal_v50 belongs in rollback/history, not beside v51.
