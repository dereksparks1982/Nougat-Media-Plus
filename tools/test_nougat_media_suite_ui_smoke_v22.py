...
BINARY=pathlib.Path(sys.argv[2]).resolve() if len(sys.argv)>2 else ROOT/'Nougat_Media_Suite_v22'
...
with tempfile.TemporaryDirectory(prefix='nms-v22-ui.') as raw:
    ...
    shutil.copy2(BINARY,app/'Nougat_Media_Suite_v22')
    ...
    echo nougat-media-suite-v22-ui-window=pass
    """)
