...
need('VERSION 0.0.30' in cm and 'Nougat_Play_Portal_v30' in cm,'CMake v30 identity missing')
need('src/media_server/library_metadata_cache.cpp' in cm,'metadata cache not compiled')
need('printf("Nougat Play Portal v0.0.30\\n")' in main,'runtime v30 identity missing')
...
if exe is not None:
    need(subprocess.check_output([str(exe),'--version'],text=True).strip()=='Nougat Play Portal v0.0.30','executable version mismatch')
