...
p = (root / 'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_38.sh').read_text(errors='replace')
checks = {
    'base-v37': 'exact accepted v0.0.37 touched state' in p and 'Nougat_Play_Portal_v37' in p,
    'repair-base-v38': 'exact known rejected v0.0.38 candidate' in p and 'v38-repair' in p and 'Nougat_Play_Portal_v38' in p,
    ...
    'repair-exe-rollback': 'rollback_root/project/Nougat_Play_Portal_v38' in p,
    'repair-manifest-rollback': 'rollback_root/project/NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v38.json' in p,
    'running-exe-safe-replace': 'atomic_replace_file' in p and 'mv -f -- "$tmp" "$dest"' in p,
    'root-executable': 'Nougat_Play_Portal_v38' in p and 'install_final' in p,
    ...
    'v38-tests': 'test_nougat_play_portal_v38.py' in p and '--v38-library-live-tv-player-self-test' in p,
    ...
    'old-version-last': 'remove_old_version_files' in p and 'NougatPlayPortal_v37.desktop' in p,
