...
p = (root / 'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_37.sh').read_text(errors='replace')
checks = {
    'base-v36': 'accepted-v0.0.36 preflight' in p and 'Nougat_Play_Portal_v36' in p and 'Accepted v0.0.36 touched-state hashes verified.' in p,
    ...
    'root-executable': 'Nougat_Play_Portal_v37' in p and 'install_final' in p,
    ...
    'v37-tests': 'test_nougat_play_portal_v37.py' in p and '--v37-live-tv-system-self-test' in p,
    'v36-regression': '--v36-library-ui-player-self-test' in p,
    'full-native-build': 'build_full' in p and 'REDDMEDIA_P2P_STUB=ON' in p,
    'old-version-last': 'remove_old_version_files' in p and 'NougatPlayPortal_v36.desktop' in p,
