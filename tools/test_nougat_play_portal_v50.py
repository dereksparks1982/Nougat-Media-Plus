...
def main():
  try:
    ...
    need('add_executable(Nougat_Play_Portal_v50' in cmake,'v50 native target missing')
    ...
    need('Nougat Play Portal v0.0.50' in maincpp,'visible/diagnostic v50 identity missing')
    ...
    for rel in ('NougatPlayPortal.desktop','com.elderredsoftworks.NougatPlayPortal.desktop'):
        need('Nougat_Play_Portal_v50' in text(rel),f'{rel}: v50 executable target missing')
