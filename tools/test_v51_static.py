...
scope=(root/'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_51_SCOPE.md').read_text(encoding='utf-8')
...
checks={
 'CMake v51': 'VERSION 0.0.51' in cmake and 'Nougat_Play_Portal_v51' in cmake,
 'visible v51 header': 'const std::string versionLabel = "v0.0.51";' in main,
 'diagnostic v51': 'input.app_version = "Nougat Play Portal v0.0.51";' in main,
 'CLI v51': 'printf("Nougat Play Portal v0.0.51\\n");' in main,
 ...
 'canonical GNOME application identity': '_GTK_APPLICATION_ID' in main and '_BAMF_DESKTOP_FILE' in main and 'com.elderredsoftworks.NougatPlayPortal' in main,
 ...
 'World TV v51 UA': 'NougatPlayPortal/0.0.51' in worker,
 ...
 'singular Archive root only': "correct=dklab/'Archive'" in builder and "archive_root=archive_base/'Nougat Play Portal'" in builder and "DKLab/Archives/Nougat Play Portal" not in builder,
