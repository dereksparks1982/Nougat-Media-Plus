...
need('VERSION 0.0.43' in cmake and 'Nougat_Play_Portal_v43' in cmake, 'v43 CMake identity missing')
...
need(readme.startswith('# Nougat Play Portal v0.0.43'), 'README v43 identity missing')
...
for desktop in ('NougatPlayPortal.desktop','com.elderredsoftworks.NougatPlayPortal.desktop'):
    d = read(desktop)
    need('Nougat_Play_Portal_v43' in d, desktop + ' does not launch v43')
    need('Icon=nougat-play-portal-concept-sheet-v24' in d, desktop + ' lost approved N icon')
...
if exe is not None:
    ...
    need(ver.returncode == 0 and ver.stdout.strip() == 'Nougat Play Portal v0.0.43',
...
print('Nougat Play Portal v0.0.43 contract PASS')
