...
need('VERSION 0.0.29' in cm and 'Nougat_Play_Portal_v29' in cm,'CMake v29 identity missing')
need('printf("Nougat Play Portal v0.0.29\\n")' in main,'runtime v29 identity missing')
...
if exe is not None:
    need(subprocess.check_output([str(exe),'--version'],text=True).strip()=='Nougat Play Portal v0.0.29','executable version mismatch')
