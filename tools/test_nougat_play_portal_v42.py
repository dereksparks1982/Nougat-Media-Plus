...
# Release identity.
need('VERSION 0.0.42' in cmake and 'Nougat_Play_Portal_v42' in cmake, 'v0.0.42 CMake identity missing')
need('const std::string versionLabel = "v0.0.42";' in main, 'v0.0.42 top-bar version missing')
need(readme.startswith('# Nougat Play Portal v0.0.42'), 'README version missing')
...
for desktop in ('NougatPlayPortal.desktop','com.elderredsoftworks.NougatPlayPortal.desktop'):
    desktop_text = read(desktop)
    need('Nougat_Play_Portal_v42' in desktop_text, desktop + ' does not launch v42')
    need('Icon=nougat-play-portal-concept-sheet-v24' in desktop_text, desktop + ' does not use approved N icon key')
...
need(sha256('assets/icons/nougat-play-portal-concept-sheet-v24.png') ==
     '681ece987dd00d9958cf953939403bd71a5ad9d70d8ad284e133272a0204d804',
     'approved concept-sheet N master changed')
need(sha256('src/nougat_play_portal_icon_data.hpp') ==
     'c626664598d57a3756a62a425875fd48567ae4eaa8c9b5a385ccf4630a0b22cb',
     'embedded X11 Nougat icon data changed')
for rel in (
    'assets/icons/nougat-play-portal-16.png', 'assets/icons/nougat-play-portal-32.png',
    'assets/icons/nougat-play-portal-48.png', 'assets/icons/nougat-play-portal-64.png',
    'assets/icons/nougat-play-portal-128.png', 'assets/icons/nougat-play-portal-256.png',
...
need('#include "nougat_play_portal_icon_data.hpp"' in main and 'append_net_wm_icon' in main,
...
if exe is not None:
    ...
    need(version.returncode == 0 and version.stdout.strip() == 'Nougat Play Portal v0.0.42',
...
print('Nougat Play Portal v0.0.42 contract PASS')
