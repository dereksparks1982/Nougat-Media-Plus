...
need('Nougat Play Portal v0.0.22' in main, 'v0.0.22 CLI version marker missing')
need('project(NougatPlayPortal VERSION 0.0.22 LANGUAGES CXX)' in cmake, 'CMake version mismatch')
need('add_executable(Nougat_Play_Portal_v22' in cmake, 'v22 executable target mismatch')
...
need('Exec=/home/dereksparks1982/DKLab/Projects/Nougat Play Portal/Nougat_Play_Portal_v22' in desktop, 'desktop launcher does not use renamed project path/v22 executable')
