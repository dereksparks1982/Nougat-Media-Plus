...
p = (root / 'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_39.sh').read_text(errors='replace')
checks = {
    'base-v38': 'exact accepted v0.0.38 touched state' in p and 'Nougat_Play_Portal_v38' in p,
    ...
    'root-executable': 'Nougat_Play_Portal_v39' in p and 'install_final' in p,
    ...
    'v39-tests': 'test_nougat_play_portal_v39.py' in p and '--v39-diagnostics-live-tv-self-test' in p,
    ...
    'old-version-last': 'remove_old_version_files' in p and 'NougatPlayPortal_v38.desktop' in p,
