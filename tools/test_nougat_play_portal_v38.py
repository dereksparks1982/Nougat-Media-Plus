...
need('VERSION 0.0.38' in cm and 'Nougat_Play_Portal_v38' in cm and 'Nougat_Play_Portal_v37' not in cm,
     'v0.0.38 CMake/target identity missing')
need(readme.startswith('# Nougat Play Portal v0.0.38\n'), 'README v0.0.38 identity missing')
...
for rel in ('NougatPlayPortal.desktop','NougatPlayPortal_v38.desktop','com.elderredsoftworks.NougatPlayPortal.desktop'):
    text = (root / rel).read_text(errors='replace')
    need('Nougat_Play_Portal_v38' in text, 'v38 launcher identity missing: ' + rel)
...
if exe:
    ...
    need(out == 'Nougat Play Portal v0.0.38', 'v38 version mismatch: ' + repr(out))
