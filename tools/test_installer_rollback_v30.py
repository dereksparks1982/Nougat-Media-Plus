...
installer=root/'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_30.sh'
manifest=root/'NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v30.json'
...
need('Nougat_Play_Portal_v29' in text and 'Nougat Play Portal v0.0.29' in text,'accepted v29 executable gate/rollback missing')
need('Nougat_Play_Portal_v30' in text and 'Nougat Play Portal v0.0.30' in text,'v30 final executable/version gate missing')
...
need('apply_raw_icon "$project_root/Nougat_Play_Portal_v30"' in text,'final raw icon application missing')
need(text.index('cp "$build_root/full/Nougat_Play_Portal_v30"') < text.index('apply_raw_icon "$project_root/Nougat_Play_Portal_v30"'),
...
for token in [
    'tools/test_nougat_play_portal_retained_v29.py','tools/test_nougat_play_portal_v30.py',
    'tools/test_nougat_play_portal_ui_smoke_v30.py','tools/test_nougat_diagnostics_v26.py',
...
for rel in [
    ...
    'NougatPlayPortal_v27.desktop','NougatPlayPortal_v28.desktop','NougatPlayPortal_v29.desktop','NougatPlayPortal_v30.desktop',
    'com.elderredsoftworks.NougatPlayPortal.desktop','src/main.cpp',
    'src/media_server/library_metadata_cache.hpp','src/media_server/library_metadata_cache.cpp',
    'tools/test_nougat_play_portal_retained_v29.py','tools/test_nougat_play_portal_v30.py',
    'tools/test_nougat_play_portal_ui_smoke_v30.py','tools/test_installer_rollback_v30.py',
    'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_30_UI_LIBRARY_PLAYER_POLISH_HANDSHAKE.md',
    'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_30_UI_LIBRARY_PLAYER_POLISH_VALIDATION.md',
    'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_30.sh','NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v30.json',
...
need('tools/test_nougat_play_portal_retained_v29.py' in source_block,'retained-v29 gate missing')
need('tools/test_nougat_play_portal_v30.py' in source_block,'v30 contract gate missing')
need('tools/test_nougat_play_portal_v29.py' not in source_block,'obsolete v29 release identity contract must not run after applying v30')
need('rm -f -- "$project_root/Nougat_Play_Portal_v29"' in text,'accepted v29 root replacement cleanup missing')
