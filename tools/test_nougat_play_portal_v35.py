...
need('VERSION 0.0.35' in cm and 'Nougat_Play_Portal_v35' in cm, 'v0.0.35 CMake identity missing')
...
need('# Nougat Play Portal v0.0.35\n\nNougat Play Portal is the new official identity' in readme,
...
for rel in ('NougatPlayPortal.desktop', 'NougatPlayPortal_v35.desktop', 'com.elderredsoftworks.NougatPlayPortal.desktop'):
    text = (root / rel).read_text(errors='replace')
    need('Nougat_Play_Portal_v35' in text, f'v35 launcher identity missing: {rel}')
...
if exe:
    ...
    need(out == 'Nougat Play Portal v0.0.35', f'v35 version mismatch: {out!r}')
