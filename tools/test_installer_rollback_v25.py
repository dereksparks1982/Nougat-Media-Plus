...
source=(ROOT/'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_25.sh').read_text(encoding='utf-8')
...
required={
 'APPLY_COMMAND.txt','CHANGELOG.md','INSTALL_NOUGAT_PLAY_PORTAL_v0_0_25.sh',
 'NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v25.json','src/main.cpp',
 'tools/test_installer_rollback_v25.py','tools/test_nougat_play_portal_v25.py',
 'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_25_STREAM_SELECTION_DISCOVER_PLAY_HANDSHAKE.md',
 'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_25_STREAM_SELECTION_DISCOVER_PLAY_VALIDATION.md',
}
...
visual={
 'assets/icons/nougat-play-portal.png','assets/icons/nougat-play-portal-concept-sheet-v24.png',
 'assets/ui/nougat-quilt-source.png','src/nougat_play_portal_icon_data.hpp','src/nougat_quilt_texture_data.hpp'
}
...
manifest=json.loads((ROOT/'NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v25.json').read_text(encoding='utf-8'))
...
for marker in [
 ...
 'Nougat Play Portal v0.0.25',
 'verify_git_state', 'verify_manifest', 'save_rollback_snapshot', 'restore_rollback',
 'Nougat_Play_Portal_v25',
 'python3 "$project_root/tools/test_nougat_play_portal_v25.py"',
 'python3 "$project_root/tools/test_nougat_play_portal_ui_smoke_v25.py"',
 'metadata::custom-icon',
 'FINAL PASS: Nougat Play Portal v0.0.25 Stream provider panel removal repair installed and validated.'
]:
    need(marker in source,'missing repair installer contract: '+marker)

need('[[ -x "$project_root/Nougat_Play_Portal_v24" ]]' not in source,'same-version repair incorrectly requires v24 executable')
need('--version 2>/dev/null)" == "Nougat Play Portal v0.0.24"' not in source,'same-version repair incorrectly validates v24 runtime')
