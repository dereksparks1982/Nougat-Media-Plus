...
p = (root / 'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_36.sh').read_text(errors='replace')
checks = {
    ...
    'root-executable': 'Nougat_Play_Portal_v36' in p and 'install_final' in p,
    ...
    'v36-tests': 'test_nougat_play_portal_v36.py' in p and '--v36-library-ui-player-self-test' in p,
    'v35-regression': '--v35-cleanup-self-test' in p,
    'full-native-build': 'build_full' in p and 'REDDMEDIA_P2P_STUB=ON' in p,
    'old-version-last': 'remove_old_version_files' in p and 'NougatPlayPortal_v35.desktop' in p,
}
