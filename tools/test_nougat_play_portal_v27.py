...
need('VERSION 0.0.27' in cm and 'Nougat_Play_Portal_v27' in cm,'CMake v27 identity missing')
need('printf("Nougat Play Portal v0.0.27\\n")' in main,'runtime v27 identity missing')
...
if exe is not None:
    need(subprocess.check_output([str(exe),'--version'],text=True).strip()=='Nougat Play Portal v0.0.27','executable version mismatch')
