...
source=(ROOT/'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_26.sh').read_text(encoding='utf-8')
...
required={
 ...
 'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_26.sh','NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v26.json',
 'NougatPlayPortal_v26.desktop','src/main.cpp','src/nougat_play_portal_icon_data.hpp',
 'src/diagnostics/diagnostic_engine.cpp','src/diagnostics/diagnostic_engine.hpp','src/diagnostics/diagnostic_types.hpp',
 'tools/test_nougat_diagnostics_v26.py','tools/test_nougat_play_portal_retained_v25.py',
 'tools/test_nougat_play_portal_v26.py','tools/test_nougat_play_portal_ui_smoke_v26.py','tools/test_installer_rollback_v26.py',
 'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_26_SYSTEMS_NAV_DIAGNOSTICS_UP_NEXT_HANDSHAKE.md',
 'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_26_SYSTEMS_NAV_DIAGNOSTICS_UP_NEXT_VALIDATION.md',
}
...
for icon in ['assets/icons/nougat-play-portal.png','assets/icons/nougat-play-portal-14.png','assets/icons/nougat-play-portal-512.png','assets/icons/nougat-play-portal-concept-sheet-v24.png']:
    need(icon in modified,'cleaned app-wide N path missing: '+icon)

manifest=json.loads((ROOT/'NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v26.json').read_text(encoding='utf-8'))
...
for rel in ['NougatPlayPortal_v26.desktop','INSTALL_NOUGAT_PLAY_PORTAL_v0_0_26.sh','NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v26.json','Nougat_Play_Portal_v26']:
    if rel != 'NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v26.json':
...
for marker in [
 ...
 'accepted v0.0.25', 'Nougat Play Portal v0.0.26', 'verify_git_state', 'verify_manifest',
 'save_rollback_snapshot', 'restore_rollback', 'Nougat_Play_Portal_v25', 'Nougat_Play_Portal_v26',
 'python3 "$project_root/tools/test_nougat_diagnostics_v26.py"',
 'python3 "$project_root/tools/test_nougat_play_portal_retained_v25.py"',
 'python3 "$project_root/tools/test_nougat_play_portal_v26.py"',
 'python3 "$project_root/tools/test_nougat_play_portal_ui_smoke_v26.py"',
 'metadata::custom-icon',
 'P2P expansion remains roadmap v0.0.28',
 'FINAL PASS: Nougat Play Portal v0.0.26 Systems, Navigation, Diagnostics, and TV Up Next installed and validated.'
]:
