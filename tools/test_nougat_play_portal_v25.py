...
need("add_executable(Nougat_Play_Portal_v25" in cmake, "v25 executable target missing")
need("Nougat Play Portal v0.0.25" in main, "CLI v25 version marker missing")
