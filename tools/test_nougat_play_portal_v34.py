...
need('VERSION 0.0.34' in cm and 'Nougat_Play_Portal_v34' in cm,'v0.0.34 CMake identity missing')
...
for rel in ('NougatPlayPortal.desktop','NougatPlayPortal_v34.desktop','com.elderredsoftworks.NougatPlayPortal.desktop'):
    text=(root/rel).read_text(errors='replace')
    need('Nougat_Play_Portal_v34' in text,f'v34 launcher identity missing: {rel}')
...
if exe:
    ...
    need(out=='Nougat Play Portal v0.0.34',f'v34 version mismatch: {out!r}')
