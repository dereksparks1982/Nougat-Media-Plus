...
installer=root/'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_32.sh'
manifest=root/'NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v32.json'
...
need('Nougat_Play_Portal_v31' in text and 'Nougat Play Portal v0.0.31' in text,'accepted v31 executable gate/rollback missing')
need('Nougat_Play_Portal_v32' in text and 'Nougat Play Portal v0.0.32' in text,'v32 final executable/version gate missing')
...
need('apply_raw_icon "$project_root/Nougat_Play_Portal_v32"' in text,'final raw icon application missing')
need(text.index('cp "$build_root/full/Nougat_Play_Portal_v32"') < text.index('apply_raw_icon "$project_root/Nougat_Play_Portal_v32"'),'raw icon must follow final executable write')
need('gio info -a metadata::custom-icon' in text,'raw icon readback missing')
for token in [
    'tools/test_nougat_play_portal_retained_v31.py','tools/test_nougat_play_portal_v32.py',
    'tools/test_nougat_play_portal_ui_smoke_v32.py','tools/test_p2p_stream_server_v32.py',
...
for rel in [
    ...
    'NougatPlayPortal.desktop','NougatPlayPortal_v32.desktop','com.elderredsoftworks.NougatPlayPortal.desktop',
    ...
    'tools/test_nougat_play_portal_retained_v31.py','tools/test_nougat_play_portal_v32.py',
    'tools/test_nougat_play_portal_ui_smoke_v32.py','tools/test_p2p_stream_server_v32.py','tools/test_installer_rollback_v32.py',
    'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_32_NATIVE_P2P_MEDIA_AND_PLAYER_UI_REPAIR_HANDSHAKE.md',
    'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_32_NATIVE_P2P_MEDIA_AND_PLAYER_UI_REPAIR_VALIDATION.md',
    'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_32.sh','NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v32.json',
...
need('rm -f -- "$project_root/Nougat_Play_Portal_v31"' in text,'accepted v31 root replacement cleanup missing')
for rel in ['INSTALL_NOUGAT_PLAY_PORTAL_v0_0_31.sh','NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v31.json','NougatPlayPortal_v31.desktop']:
...
need('rollback_root/project/Nougat_Play_Portal_v32' in text,'replacement rollback does not preserve first-v32 executable')
