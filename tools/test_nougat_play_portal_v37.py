...
need('VERSION 0.0.37' in cm and 'Nougat_Play_Portal_v37' in cm and 'Nougat_Play_Portal_v36' not in cm,
     'v0.0.37 CMake/target identity missing')
protected = ('# Nougat Play Portal v0.0.37\n\n'
...
for rel in ('NougatPlayPortal.desktop','NougatPlayPortal_v37.desktop','com.elderredsoftworks.NougatPlayPortal.desktop'):
    text=(root/rel).read_text(errors='replace')
    need('Nougat_Play_Portal_v37' in text, 'v37 launcher identity missing: '+rel)
...
if exe:
    ...
    need(out=='Nougat Play Portal v0.0.37', 'v37 version mismatch: '+repr(out))
