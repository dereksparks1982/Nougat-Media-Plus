...
installer=root/'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_29.sh'
manifest=root/'NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v29.json'
...
need('Nougat_Play_Portal_v28' in text and 'Nougat Play Portal v0.0.28' in text,'accepted v28 executable gate/rollback missing')
need('Nougat_Play_Portal_v29' in text and 'Nougat Play Portal v0.0.29' in text,'v29 final executable/version gate missing')
...
need('apply_raw_icon "$project_root/Nougat_Play_Portal_v29"' in text,'final raw icon application missing')
need(text.index('cp "$build_root/full/Nougat_Play_Portal_v29"') < text.index('apply_raw_icon "$project_root/Nougat_Play_Portal_v29"'),
...
for token in [
    'tools/test_nougat_play_portal_retained_v28.py','tools/test_nougat_play_portal_v29.py',
    'tools/test_nougat_play_portal_ui_smoke_v29.py','tools/test_nougat_diagnostics_v26.py',
...
for rel in [
    ...
    'NougatPlayPortal_v27.desktop','NougatPlayPortal_v28.desktop','NougatPlayPortal_v29.desktop',
    'com.elderredsoftworks.NougatPlayPortal.desktop','src/main.cpp',
    'tools/test_nougat_play_portal_retained_v28.py','tools/test_nougat_play_portal_v29.py',
    'tools/test_nougat_play_portal_ui_smoke_v29.py','tools/test_installer_rollback_v29.py',
    'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_29_TV_RELIABILITY_AND_UI_REPAIR_HANDSHAKE.md',
    'docs/builds/NOUGAT_PLAY_PORTAL_v0_0_29_TV_RELIABILITY_AND_UI_REPAIR_VALIDATION.md',
    'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_29.sh','NOUGAT_PLAY_PORTAL_PATCH_MANIFEST_v29.json',
...
need('tools/test_nougat_play_portal_retained_v28.py' in source_block,'retained-v28 gate missing')
need('tools/test_nougat_play_portal_v29.py' in source_block,'v29 contract gate missing')
need('tools/test_nougat_play_portal_v28.py' not in source_block,'obsolete v28 identity contract must not run after applying v29')
need('--v29-tv-reliability-self-test' in text,'runtime TV reliability self-test missing')
need('rm -f -- "$project_root/Nougat_Play_Portal_v28"' in text,'accepted v28 root replacement cleanup missing')
