...
need("add_executable(Nougat_Play_Portal_v26" in cmake, "v26 executable target missing")
need("Nougat Play Portal v0.0.26" in main, "CLI v26 version marker missing")
