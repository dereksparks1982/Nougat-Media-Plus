...
need('add_executable(Nougat_Play_Portal_v23' in cmake, 'v23 executable target missing')
need('Nougat_Play_Portal_v22' not in cmake, 'v22 target leaked into CMake')
need('Nougat Play Portal v0.0.23' in main, 'CLI v0.0.23 marker missing')
need('const std::string versionLabel = "v0.0.23"' in main, 'in-app v0.0.23 marker missing')
need('Nougat_Play_Portal_v23' in desktop, 'desktop launcher does not target v23')
...
need((root/'src/nougat_play_portal_icon_data.hpp').is_file(), 'embedded X11 icon data missing')
