...
p=(root/'INSTALL_NOUGAT_PLAY_PORTAL_v0_0_34.sh').read_text(errors='replace')
checks={
...
'root-executable':'Nougat_Play_Portal_v34' in p and 'install_final' in p,
...
'v34-tests':'test_nougat_play_portal_v34.py' in p and '--v34-ui-polish-self-test' in p,
}
