...
need('VERSION 0.0.28' in cm and 'Nougat_Play_Portal_v28' in cm,'CMake v28 identity missing')
need('printf("Nougat Play Portal v0.0.28\\n")' in main,'runtime v28 identity missing')
...
if exe is not None:
    need(subprocess.check_output([str(exe),'--version'],text=True).strip()=='Nougat Play Portal v0.0.28','executable version mismatch')
