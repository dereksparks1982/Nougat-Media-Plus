#!/usr/bin/env python3
"""Deterministic v0.0.20 UI-contract plus retained behavior validation."""
...
for marker in (
    ...
    'draw_tab(ytdlpTab,"Stream"',
    'draw_tab(p2pTab,"P2P"',
    'draw_tab(debugTab,"Debug"',
    'StreamPlatform::YouTube',
    'StreamPlatform::Rumble',
    'StreamPlatform::RuTube',
    'StreamPlatform::VK',
    'StreamPlatform::OK',
    '"Direct Watch"',
    '"Open Webpage"',
    'draw_stream_screen(buffer)',
    'palette_for(ViewMode::Stream)',
    'webpage in your default browser',
    'std::min(200, vol + delta)',
    'volRect.w*vol/200',
    '"100%"',
    'controlTotalW <= controlViewportW',
    ...
    require(marker in main_source, f"missing v0.0.20 behavior marker: {marker}")

# Exact owner-approved v0.0.20 top-level order.
order_markers = [
    'draw_tab(videoPlayerTab,"Video Player"',
    'draw_tab(libraryTab,"Library"',
    'draw_tab(discoverTab,"Discover"',
...
# Interior themes: Video Player red family, Library green, Discover plum, Stream teal, P2P blue, Debug amber, Nougat candy-bar.
for rgb in (
    'col(0x2414,0x0b0b,0x0b0b)',
    'col(0x3b3b,0x1515,0x1515)',
    'col(0x1414,0x2828,0x1919)',
    'col(0x2020,0x3c3c,0x2828)',
    'col(0x2626,0x1515,0x2c2c)',
    'col(0x3a3a,0x2121,0x4242)',
    'col(0x0d0d,0x2323,0x2626)',
    'col(0x1616,0x3838,0x3c3c)',
    'col(0x0e0e,0x1b1b,0x2a2a)',
    'col(0x1818,0x3131,0x4a4a)',
    'col(0x2b2b,0x2424,0x1616)',
    'col(0x4343,0x3535,0x1a1a)',
    ...
    require(rgb in main_source, f"required v0.0.20 palette marker missing: {rgb}")
...
print('ui-contract=pass palettes=pass stream=pass volume-200=pass centered-controls=pass library-grid-list=pass caret=pass tv-autoplay=pass viewing-history-completion=pass')
...
with tempfile.TemporaryDirectory(prefix="reddmedia-v19-tests-") as temporary:
    ...
    try:
        ...
        raise SystemExit(f"v0.0.20 metadata test requires free localhost port 8096: {exc}") from exc
...
print("ReddMedia v0.0.20 deterministic validation PASS")
