...
print('retained-behavior-harness=start')
...
int main(int argc, char** argv) {
    ...
    if (report.find("Nougat Play Portal Diagnostic Report") == std::string::npos ||
...
print("Nougat Play Portal v0.0.22 retained deterministic validation PASS")
