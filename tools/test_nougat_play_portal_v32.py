...
need('VERSION 0.0.32' in cm and 'Nougat_Play_Portal_v32' in cm,'CMake v32 identity missing')
need('printf("Nougat Play Portal v0.0.32\\n")' in main and 'const std::string versionLabel = "v0.0.32"' in main,'runtime/in-app v32 identity missing')
...
if exe is not None:
    need(subprocess.check_output([str(exe),'--version'],text=True).strip()=='Nougat Play Portal v0.0.32','v32 executable version mismatch')
