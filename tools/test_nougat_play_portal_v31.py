...
need('VERSION 0.0.31' in cm and 'Nougat_Play_Portal_v31' in cm,'CMake v31 identity missing')
need('printf("Nougat Play Portal v0.0.31\\n")' in main,'runtime v31 identity missing')
...
if exe is not None:
    need(subprocess.check_output([str(exe),'--version'],text=True).strip()=='Nougat Play Portal v0.0.31','executable version mismatch')
