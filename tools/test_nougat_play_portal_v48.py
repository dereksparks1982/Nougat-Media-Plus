...
def main() -> None:
    parser_self_test()
    print("=== NOUGAT PLAY PORTAL v0.0.48 DOS + XBOX 360 CONTRACT ===")
    ...
    for token in [
        ...
        "add_executable(Nougat_Play_Portal_v48",
        "src/games/emulator_host.cpp",
        "target_compile_options(Nougat_Play_Portal_v48 PRIVATE -Wall -Wextra -Werror)",
    ]:
