...
need('VERSION 0.0.39' in cm and 'Nougat_Play_Portal_v39' in cm,'v0.0.39 CMake identity missing')
...
if exe:
    ...
    out=subprocess.check_output([str(exe),'--version'],text=True,stderr=subprocess.STDOUT).strip(); need(out=='Nougat Play Portal v0.0.39','v39 version mismatch: '+repr(out))
